...
import { ArrowRight, User, Shield, Ban } from "lucide-react";
import GoogleCalendarModal, { useGoogleCalendarModal } from "@/components/GoogleCalendarModal";

const reassurancePoints = [
  {
    icon: User,
    text: "Single point of contact from discovery to delivery",
  },
  {
    icon: Shield,
...
const FinalCTA = () => {
  ...
  return (
    <>
      <section id="contact" className="py-16 md:py-20 lg:py-24 bg-carbon">
